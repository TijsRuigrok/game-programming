...
public class GameSceneController : MonoBehaviour
{
    ...
    private List<IEndGameObserver> endGameOberservers;
    public void AddObserver(IEndGameObserver observer)
    {
        endGameOberservers.Add(observer);
    }

    public void RemoveObserver(IEndGameObserver observer)
    {
        endGameOberservers.Remove(observer);
    }

    private void NotifyObservers()
    {
        foreach(IEndGameObserver observer in endGameOberservers)
        {
            observer.Notify();
        }
    }
    ...
    private void Awake()
    {
        endGameOberservers = new List<IEndGameObserver>();
    }
